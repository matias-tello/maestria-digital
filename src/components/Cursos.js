...
<h1>Tu Puerta hacia el Éxito</h1>
      <div className="cont-todos-cursos">

      {Productos.map((curso, item) => (

        <div id={curso.id}  className="cont-curso">

          <h2>  {curso.titulo} </h2>

         <img src={curso.imgUrl} alt=""  className="img-curso" />

         <p className="texto-curso">{curso.descripcion}</p>

         <button>  <a href={curso.link}> Comprar </a>  </button>
